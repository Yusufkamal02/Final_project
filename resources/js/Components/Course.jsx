  ...
  return (
    <div className="px-20" id="course">
        ...
        <div className="flex flex-wrap justify-center gap-5 py-20">
            <div className="flex w-full md:w-5/12 lg:w-3/12 border-2 p-5 rounded-lg justify-between items-center hover:-translate-y-3 hover:shadow-xl transition duration-700 ">
